...
@section('title', '新增 ToDo')

@section('content')
<div class="max-w-2xl mx-auto px-4">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-gray-900">新增 ToDo 項目</h1>
        ...
        <form method="POST" action="{{ route('todos.store') }}">
            ...
            <div class="mb-4">
                ...
                <textarea id="description" 
                          ...
                          placeholder="輸入詳細描述（可選）">{{ old('description') }}</textarea>
                @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select id="status" 
                    ...
                    <option value="pending" {{ old('status') === 'pending' ? 'selected' : '' }}>待處理</option>
